...
public class Listener extends Base implements ITestListener {
    ...
    public void onTestFailure(ITestResult iTestResult) {
        logger.info(
                "->TestFail: " + iTestResult.getMethod().getMethodName() + " on " + iTestResult.getTestClass().getName
                        () + " class ");
        ...
        String screenShotName = location.getAbsoluteFile() + File.separator + packageClassName + "_" + methodName + 
                "_" + formatedDate + ".png";
